# Fonts shipped with Flexwall

Flexwall serves these font families from `apps/web/public/fonts`. Each one is
licensed under the SIL Open Font License, Version 1.1, which asks that the
licence and its copyright notices travel with the font files. They are all
reproduced here.

The rest of Flexwall is under the licence in the repository root; these fonts
